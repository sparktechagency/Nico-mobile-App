...
import { aboutIcon, Downarrow, imageupload, rightArrow, successmodalIcon, videoUpload } from '../../../assets/Icons/icons';
...
const SuccessModal = ({ visible, onClose }) => (
  <Modal visible={visible} transparent>
    ...
    <SvgXml xml={successmodalIcon}/>
        ...
        <Text style={tw`text-[16px] text-[#00950A] font-bold mb-2 text-center`}>SEND SUCCESSFULLY</Text>
        <Text style={tw`text-[14px] font-normal text-gray-500 text-center px-4 mb-4`}>Please be patient until the user accept the quotation</Text>
        <TouchableOpacity
